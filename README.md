# Penerapan Algoritma Decision Tree dalam Kasus Penentuan Kelayakan Modal

Aplikasi ini merupakan penerapan dari algoritma decision tree dengan urutan langkahnya secara bertahap dalam kasus menentukan kelayakan modal menggunakan sintaks ES6.
...
```
git clone git@github.com:DonzTea/capital-eligibility-using-decision-tree.git
```

2.  Masuk ke folder yang telah di-clone tersebut dengan perintah :

```
cd capital-eligibility-using-decision-tree
```
